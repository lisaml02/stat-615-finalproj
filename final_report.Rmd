...
```{r exib model 1}
glm_exib_1 <- glm(se_1 ~ know_1 + att_1 + se_3 + pn_1 + exp + decision_combined + wg + received_antenatal_care + age + parity + any_edu + wealth, 
              data = niger, 
              family = binomial)
...
# Odds Ratio
glm_exib_1 <- exp(coef(glm_exib_1))
glm_exib_1
```
...
# Odds Ratio
glm_exib_2 <- exp(coef(glm_exib_2))
glm_exib_2
```
...
# Odds Ratio
glm_exib_3 <- exp(coef(glm_exib_3))
glm_exib_3
```
