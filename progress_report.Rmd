...
Fitted Regression surface: logit$p_{i}$ = -1.47 + 1.45$X_1$ + 0.306$X_2$ + 1.88$X_3$ - 1.26$X_4$ + 1.67$X_5$ + 0.108$X_6$ + 0.395$X_7$ - 0.133$X_8$
note: this is without controls in order to be consistent with the format of the other models 
...
Fitted Regression surface: logit$p_{i}$ = -2.27 + 1.49$X_1$ + 0.429$X_2$ + 1.62$X_3$ - 1.13$X_4$ + 1.55$X_5$ + 0.104$X_6$ + 0.493$X_7$ - 0.979$X_8$
note: this is without controls in order to be consistent with the format of the other models 
...
summary(model3)
```
Fitted Regression surface: logit$p_{i}$ = -1.61 + 1.46$X_1$ + 0.324$X_2$ + 1.87$X_3$ - 1.26$X_4$ + 1.67$X_5$ + 0.125$X_6$ + 0.397$X_7$ - 0.000787$X_8$
note: this is without controls in order to be consistent with the format of the other models 
...
```
Fitted Regression surface: logit$p_{i}$ = -5.29 + 2.13$X_1$ + 1.07$X_2$ + 1.21 $X_3$ + 2.54$X_4$ + 0.536$X_5$ + 0.169$X_6$ + 0.471$X_7$ - 0.117$X_8$
note: this is without controls in order to be consistent with the format of the other models 

X1: knowledge gateway 
X2: Attitude gateway 
X3: Self-efficacy 
X4: Perceived Normal Gateway 
X5:  Women's community group
X6: Decision Combined - decisions for all three categories: household purchases, healthcare, and visiting relatives
X7: Exposure 
X8: Antenatal Care
...
```
Fitted Regression surface: logit$p_{i}$ = -5.41 + 2.14$X_1$ + 1.08$X_2$ + 1.20 $X_3$ + 2.54$X_4$ + 0.544$X_5$ + 0.187$X_6$ + 0.457$X_7$ + 0.0514$X_8$
note: this is without controls in order to be consistent with the format of the other models 
...
```
Fitted Regression surface: logit$p_{i}$ = -5.15 + 2.21$X_1$ + 0.977$X_2$ + 1.19 $X_3$ + 2.70$X_4$ + 0.586$X_5$ + 0.161$X_6$ + 0.303$X_7$ -0.0215$X_8$
note: this is without controls in order to be consistent with the format of the other models 
